...
FilterWidget::FilterWidget(QWidget * parent)
    ...
    connect(m_caseSensitivityAction, &QAction::toggled, this,
    ...
    m_patternGroup->addAction(patternAction);
    connect(m_patternGroup, &QActionGroup::triggered, this,
            &FilterWidget::filterChanged);
...
Qt::CaseSensitivity FilterWidget::caseSensitivity() const {
    return m_caseSensitivityAction->isChecked() ? Qt::CaseSensitive
                                                : Qt::CaseInsensitive;
}
...
static inline QRegExp::PatternSyntax patternSyntaxFromAction(
    const QAction * a) {
